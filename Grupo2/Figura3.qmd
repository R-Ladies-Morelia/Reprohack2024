...
![Fig. 3. Los resultados de la resistencia a los fagos en el experimento de repetición reflejan los resultados de su población fundadora.](img/figure3.jpeg){width="500" height=250}
...
```{r}
replay <- read_excel("../../loss-of-resistance/Replay.xlsx", sheet = "Data")
