...
![Fig. 1. Mecanismos genéticos y costes de fitness de la resistencia a los fagos.](img/figure1.jpeg){width="500" height=250}
...
Salvar variable para la figura 2.

```{r}
save(costs_agg, file = "costs_agg.RData")
```
