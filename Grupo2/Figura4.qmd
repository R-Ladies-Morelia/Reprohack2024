...
![Fig. 4. Contingencia genética en la identidad de los genes mutados durante la evolución experimental.](img/figure4.jpeg){width="800"}
...
ggplot(test_gene_df_day6, aes(label, sim_coef)) +
