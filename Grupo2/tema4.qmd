...
![](img/Layers_ggplot.png){width="1000" height=250}

Las capas GG tienen nombres específicos que verás a lo largo de esta seccion:

![](img/gglayers.png){width="1000" height=1000}
...
![](img/ggplot2-cheatsheet-2.1-Spanish.pdf){width="1000" height=1000}

Más información en en el [Workshop 3: Introduction to data visualisation with ggplot2](https://r.qcbs.ca/workshop03/book-en/)

## Ejercicios

Te invitamos a que corras el ejercicio propuesto en el script [ggplo2_R_Ladies_Morelia_.R](https://github.com/R-Ladies-Morelia/GGplotShiny/blob/main/ggplot2_R_ladies_Morelia/ggplo2_R_Ladies_Morelia_.R) por Fernanda Miron. 
